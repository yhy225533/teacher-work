...
| V110-A 备课状态保活（问题 5） | TODO | App.tsx picker 往返不卸载教学内容页（DraftPanel 勾选/要求/模式/流式状态保留）+ copyToLesson/importToLesson 补发既有 contentChanged 广播 + 钉测；设计基准 docs/v1.10-walkthrough-fixes-plan.md §2 / D61 |
