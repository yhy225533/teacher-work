...
| V18-D 最终门禁与验收 | IN_PROGRESS | 全量测试、typecheck、lint、production build、diff check；隔离 Windows 冒烟（一对一确认/跳过/补写/幂等、班课 3 学生 1 请假、fake provider）；DeepSeek 真实自测（预估 ≤ ¥1，产品负责人执行）；`docs/v1.8-acceptance.md`；确认后创建 `checkpoint-V1.8-pass` |
